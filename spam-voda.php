...
<title>spam Tupac</title>
<p></p>
    <h1>مرحبا بك عزيزي 
    </p>
    فودافون</h1>
<p></p>
<body background="https://dev-zekoeg.pantheonsite.io/LOL/spam1/photo_2023-02-23_03-21-14.jpg">
<br>
</div>
</div>
</head>
...
<p></p>
    ...
    <p></p>
        <input type="text" name="search" placeholder="الرقم">
        <p></p>
...
if(isset($_POST['search'])){
    $search = $_POST['search'];
    $data = file_get_contents("https://z63k.tk/API/spam/Vodafone-sms.php?number=".$search);
...
box-shadow:2px 3px 9px rgba(0,0,3,3);
